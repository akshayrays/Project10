 ...
 */
@RestController
//spring container ko btyega ki humara ye ctl hai -@restctl
@RequestMapping(value = "Auth")

//jo b req arai h usko url ke sath ctl par map krta @reqMaping
public class LoginCtl extends BaseCtl<UserForm, UserDTO, UserServiceInt> {
	...
	public ORSResponse login(@RequestBody @Valid LoginForm form, BindingResult bindingResult, HttpSession session,HttpServletRequest request)throws Exception {
		...
		//req ke sath jo data usko method ke parameter ke sath bind kara @reqbody
		//@valid se validation check kara
		//bindingresult ke obj me error msgs hold kara
